...
%% run optimization
% unimodal
[data1_um, aux_um, isi_um] = run_unimodal(X, S, M, num_pc, num_iter, Y, A);

% unimodal + multimodal
[data1_ummm, aux_ummm, isi_ummm] = run_multimodal_unimodal(X, S, M, num_pc, num_iter, Y, A);
...
[data1_um_s1, aux_um_s1, isi_um_s1] = run_unimodal(X, S1_, M, num_pc, num_iter, Y, A);
[data1_ummm_s1, aux_ummm_s1, isi_ummm_s1] = run_multimodal_unimodal(X, S1_, M, num_pc, num_iter, Y, A);
...
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_234111_incorrect2222211';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_234111_incorrect333111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_234111_incorrect441111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_2222211_incorrect333111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_2222211_incorrect441111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_2222211_incorrect234111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_333111_incorrect2222211';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_333111_incorrect441111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_333111_incorrect234111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_441111_incorrect234111';
% outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_441111_incorrect333111';
outpath = '/Users/xli77/Documents/MISA/results/SIVA/fixedSubspace/um2mm/subspace_struct_441111_incorrect2222211';
...
save(fullfile(outpath,'um.mat'),'data1_um_s1','isi_um_s1','aux_um_s1');
save(fullfile(outpath,'ummm.mat'),'data1_ummm_s1','isi_ummm_s1','aux_ummm_s1');
...
imagesc(data1_um_s1.W{1}*sim_misa.A{1},max(max(abs(data1_um_s1.W{1}*sim_misa.A{1}))).*[-1 1]);colorbar();
title("WA, M1");
subplot(num_row,num_col,2);
imagesc(data1_um_s1.W{end}*sim_misa.A{end},max(max(abs(data1_um_s1.W{end}*sim_misa.A{end}))).*[-1 1]);colorbar();
title("WA, M2");
subplot(num_row,num_col,3);
imagesc(cat(1,data1_um_s1.W{:})*cat(2,sim_misa.A{:}),max(max(abs(cat(1,data1_um_s1.W{:})*cat(2,sim_misa.A{:})))).*[-1 1]);colorbar();
title("WA, M1&2");
subplot(num_row,num_col,4);
plot(1:num_iter+1,[aux_um_s1{2,:}],'o-');
title("Loss");

subplot(num_row,num_col,5);
imagesc(data1_ummm_s1.W{1}*sim_misa.A{1},max(max(abs(data1_ummm_s1.W{1}*sim_misa.A{1}))).*[-1 1]);colorbar();
title("WA, M1");
subplot(num_row,num_col,6);
imagesc(data1_ummm_s1.W{end}*sim_misa.A{end},max(max(abs(data1_ummm_s1.W{end}*sim_misa.A{end}))).*[-1 1]);colorbar();
title("WA, M2");
subplot(num_row,num_col,7);
imagesc(cat(1,data1_ummm_s1.W{:})*cat(2,sim_misa.A{:}),max(max(abs(cat(1,data1_ummm_s1.W{:})*cat(2,sim_misa.A{:})))).*[-1 1]);colorbar();
title("WA, M1&2");
subplot(num_row,num_col,8);
plot(1:num_iter+1,[aux_ummm_s1{2,:}],'o-');
title("Loss");
